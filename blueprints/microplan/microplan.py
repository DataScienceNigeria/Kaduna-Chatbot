...
df = pd.DataFrame(sql, columns=["lga","ward","health_facility","ownership_type","facility_type",
                                ...
                                "persons_with_disabilities","physically challengephysically_challengedd","visually_impaired",
...
#df['Coordinates'] = df['Coordinates'] = df['Coordinates'].astype(str).str.strip()
