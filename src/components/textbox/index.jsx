  ...
  if (prop.type === "population") {
    ...
    content = (
      <>
        ...
        <p>Phone number: {prop.phone_number}</p>
        <p>Permanent technical staff: {prop.permanent_technical_staff}</p>
        <p>Volunteer technical staff: {prop.volunteer_technical_staff}</p>
        <p>Permanent non-technical staff: {prop.permanent_non_technical_staff}</p>
        <p>Ward focal person: {prop.name_of_ward_ce_focal_person}</p>
        <p>Phone number: {prop.phone_number_1}</p>
      </>
    );
  } else if (prop.type === "status") {
    content = (
      <>
        <p>Ownership type: {prop.ownership_type}</p>
        <p>Facility type: {prop.facility_type}</p>
      </>
    );
